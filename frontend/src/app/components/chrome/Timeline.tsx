...
function ViewToggles() {
  ...
  // Decision 3 (design.md): rename UI from SEMI/REAL to LIN/LOG. Backing
  // logic still cycles SEMI_REALISTIC ↔ REALISTIC; #61 swaps in real log
  // compression and the labels become accurate.
